...
// LLVM-MinGW + shared Boost: archive DECL macros expand to dllimport, which
// cannot apply to non-inline .ipp template definitions included here.
#ifdef BOOST_ARCHIVE_DECL
# undef BOOST_ARCHIVE_DECL
#endif
#define BOOST_ARCHIVE_DECL
#ifdef BOOST_WARCHIVE_DECL
# undef BOOST_WARCHIVE_DECL
#endif
#define BOOST_WARCHIVE_DECL
#ifdef BOOST_ARCHIVE_OR_WARCHIVE_DECL
# undef BOOST_ARCHIVE_OR_WARCHIVE_DECL
#endif
